...
<div class="container my-4">
    <h1 class="mb-4">Create Subscription Type</h1>
    <form action="{{ route('subscription_type.store') }}" method="POST" class="bg-white p-4 rounded shadow-sm">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="number" id="number_cars_allowed" name="number_cars_allowed" class="form-control" required value="{{ old('number_cars_allowed') }}">
        </div>

        <!-- Duration Field -->
        <div class="mb-3">
            <label for="duration" class="form-label">Duration (days)</label>
            <input type="number" id="duration" name="duration" class="form-control" required value="{{ old('duration') }}">
        </div>
        ...
        <!-- Submit Button -->
        <div>
            <input type="submit" value="Save Plan" class="btn btn-primary w-100 text-black">
        </div>
    </form>
</div>
@endsection
